module github.com/praetorian-inc/product-golang-backend-interview
...
require (
	...
	github.com/projectdiscovery/subfinder/v2 v2.5.3 // todo: update this to latest (currently 2.5.5)
)
